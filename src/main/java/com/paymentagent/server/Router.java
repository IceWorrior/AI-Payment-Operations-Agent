...
public class Router {
        ...
        private void handlePayments(
                ...
                if (method.equals("GET")) {
                        ...
                        List<Payment> payments = paymentController.getPayments();
        ...
        private void handlePaymentById(
                ...
                String id = path.substring("/api/payments/".length());
        ...
        private void handleFilterPayments(
                        ...
                        for (String parameter : parameters) {
                                ...
                                switch (key) {
                                        ...
                                        case "minAmount":
                                                ...
                                                minAmount = Double.valueOf(value);

                                                break;

                                        case "maxAmount":

                                                maxAmount = Double.valueOf(value);
                ...
                List<Payment> payments = paymentController.filterPayments(
                                status,
                                paymentMethod,
                                minAmount,
                                maxAmount);
